...
<button onclick="showSection('collect',this)">Cookies Policy</button>
<button onclick="showSection('use',this)">License and Intellectual Propertyo</button>
<button onclick="showSection('share',this)">User Comments and Contributions</button>
<button onclick="showSection('rights',this)">Hyperlinking to Our Content</button>
<button onclick="showSection('security',this)">iFrames</button>
<button onclick="showSection('retention',this)">Content Liability</button>
<button onclick="showSection('thirdparty',this)">Reservation of Rightss</button>
<button onclick="showSection('transfer',this)">Removal of Links</button>
<button onclick="showSection('contact',this)">Disclaimer</button>
...
<p>
Thank you for visiting World Window Publishing’s website, located at worldwindowpublishing.com. By accessing or using our website, you agree to be bound by the terms and conditions set forth on this page. These Terms and Conditions govern your relationship with World Window Publishing and outline the rules and guidelines for using our services, browsing our site, and engaging with our platform.
</p>
<br>

<p>
Please read these Terms and Conditions carefully before using our website. Your continued use of the website signifies your acceptance of these terms in their entirety. If you do not agree to any part of these terms, you are encouraged to discontinue use of our website immediately.
</p>
<br>

<p>
Throughout this document, the terms “Client,” “You,” and “Your” refer to the individual or entity accessing our website and complying with these terms and conditions. “The Company,” “We,” “Our,” and “Us” refer to World Window Publishing. These terms, in conjunction with our Privacy Policy, Disclaimer, and any other relevant policies or agreements, establish the full scope of obligations, responsibilities, and rights between the Client and the Company.
</p>
<br>
...
<p>
We employ the use of cookies on our website to enhance your browsing experience. By accessing World Window Publishing, you agree to our use of cookies in accordance with our Privacy Policy.
</p><br>

<p>
Cookies are small files stored on your device that enable us to identify your browser and capture certain information about your visit. These files help us personalize your experience, streamline functionality, and improve the overall usability of the website. For example, cookies allow us to remember your preferences, store items in your cart, and analyze website traffic to better understand our audience
</p><br>

<p>
Some cookies are essential to the operation of the website, while others are used to gather analytical data or provide targeted advertising. Our advertising and affiliate partners may also employ cookies to track their performance on our site. You can adjust your browser settings to block or remove cookies, but doing so may limit your ability to access certain features or functionalities.
</p><br>

<p>
For a detailed explanation of how we use cookies and how you can manage them, please review our Privacy Policy.
</p><br>
...
<p>
Unless otherwise stated, World Window Publishing and/or its licensors own the intellectual property rights for all material published on this website, including but not limited to text, graphics, logos, images, videos, and software. All such rights are reserved under applicable laws.
</p><br>


<p>
You may access and use material from World Window Publishing for your personal, non-commercial purposes, provided you adhere to the restrictions outlined in these terms. This limited license does not transfer ownership or grant any additional rights.
</p><br>
...
<ul>
  <li>
 Republish material from World Window Publishing without prior written consent.
    </li>
...
Sell, rent, or sub-license material from the website.
 ...
 Reproduce, duplicate, or copy material for commercial purposes.
      ...
      <li>
 Redistribute content from the website unless explicitly authorized by us.
    </li>
</ul><br>
<p>
Certain areas of the website may allow users to contribute content, such as reviews, comments, or other submissions. By submitting any content, you grant World Window Publishing a non-exclusive, royalty-free, perpetual, and fully sublicensable license to use, reproduce, modify, adapt, publish, translate, and distribute such content in any media.
</p>
<br>
<h2>Your contributions must not:</h2>
...
Contain defamatory, offensive, or unlawful material.
      ...
      <li>
Promote unauthorized commercial activities.
    </li>
</ul>
...
<p>
World Window Publishing reserves the right to monitor user submissions and to remove content deemed inappropriate or in violation of these terms at its sole discretion. 
</p>
...
<p>
World Window Publishing allows users to post comments, reviews, and other content in certain areas of the website. By submitting such content, you acknowledge and agree to the following:
</p><br>

<h2>Ownership and Rights:</h2>
<p>
You affirm that you own or have the necessary permissions to post the content and that doing so does not infringe on any intellectual property rights, privacy rights, or other legal rights of any third party.
</p><br>
...
<ul>
  <li>
 Your comments and contributions must not
    </li>
...
Promote hate speech, violence, or discrimination.
      ...
      <li>
Solicit unlawful activities or promote unauthorized commercial ventures.
    </li>
       <li>
...
<p>
By posting content on our website, you grant World Window Publishing a non-exclusive, royalty-free, perpetual, irrevocable, and sublicensable right to use, reproduce, modify, adapt, publish, and distribute your content in any media worldwide.
</p><br>
<h2>Monitoring and Removal:</h2>
<p>
While we encourage open dialogue, World Window Publishing reserves the right to review, monitor, and remove any user content that violates these terms or is otherwise deemed inappropriate. However, we are not obligated to pre-screen content.
</p><br>
<h2>Liability Disclaimer:</h2>
<p>
The views and opinions expressed in user comments and contributions are solely those of the authors and do not necessarily reflect the views of World Window Publishing. We are not responsible or liable for any claims, damages, or disputes arising from user-submitted content.
</p><br>


<p>
By posting on our platform, you agree to these terms and accept full responsibility for your submissions.
</p><br>
...
<p>
Organizations may link to World Window Publishing’s website without prior written approval under certain conditions. These organizations include:
</p>
<br>
<h2>Permitted Entities:</h2>
...
News organizations.
      ...
      <li>
Online directory distributors, provided they link in the same manner as they hyperlink to the websites of other listed businesses.
    </li>
       <li>
...
<h2>General Linking Conditions:</h2>
<p>
Entities may link to our homepage, publications, or other website information under the following conditions:
</p>
...
The link is not misleading or deceptive.
  ...
  <li>
It does not falsely imply sponsorship, endorsement, or approval of the linking party or their products/services.
    </li>
...
<h2>Additional Requests:</h2><br>
<p>
We may consider and approve link requests from other types of organizations, such as:
</p>
...
<ul>
  <li>
The link does not harm our reputation or that of our accredited businesses.
    </li>

  <li>The organization does not have a history of negative interactions with us.
    </li>

  <li>The visibility of the link provides value to World Window Publishing.
    </li>

  <li>  The link is contextually appropriate and serves as a general resource.
...
<p>
Linking Methods: Approved organizations may hyperlink to our website using the following methods:
</p><br>
...
By use of our corporate name.
  ...
  <li>By use of the uniform resource locator (URL) being linked to.
    </li>

  <li>By any other description of our website that makes sense within the linking party’s site context.
    </li>
...
<p>
The use of World Window Publishing’s logo or other trademarks for linking purposes requires prior written approval through a trademark license agreement.
</p><br>
...
<p>
Without prior written consent and explicit permission, you may not create frames around our webpages or use any other techniques that alter the visual presentation, appearance, or functionality of our website.
</p><br>
...
This includes but is not limited to:
  ...
  <li>Creating frames that obscure our branding, content, or functionality.
    </li>

  <li>Embedding parts of our website within another website without approval.
    </li>

  
<li>Using technology to bypass or disable our website’s navigation or interactive elements.
    </li>
...
<p>
We reserve the right to revoke permissions for any such use that impacts the integrity of World Window Publishing’s platform or user experience. Requests for creating frames or similar integrations should be directed to our support team with detailed information about the intended use.
</p><br>
...
<p>World Window Publishing is not responsible for any content that appears on external websites linking to or from our platform. By linking to our website, you agree to protect and defend us against any claims arising from your site, including those related to:
</p>


<br>
<ul>
  <li>Infringing Content: Any material that infringes upon or violates third-party intellectual property rights.
    </li>

  <li>Offensive or Illegal Content: Content that may be considered libelous, obscene, unlawful, or otherwise objectionable.
    </li>

  <li>Accuracy of Information: Any inaccuracies or errors in the material you present alongside the link to our website.
    </li>
</ul>
<br>
<p>No link(s) should appear on any external website that:</p>
<br>
<ul>
  <li>
 Could be interpreted as defamatory, indecent, or unlawful.</li>

  <li>Violates any third-party rights. </li>

  <li>Damages the reputation of World Window Publishing or its stakeholders. </li>
</ul>


<br>
<p>You agree to immediately remove any links to our website upon our request if we determine they are harmful, inappropriate, or in violation of these terms.
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="f-col">
        <h4>Menu</h4>
        <ul>
          <li><a href="index.html">Home WWP</a></li>
          <li><a href="bookstore.html">Bookstore</a></li>
          <li><a href="about.html">About Us</a></li>
          <li><a href="authors.html">Authors' List</a></li>
          <li><a href="contact.html">Contact us</a></li>
          <li><a href="publishers.html">New Authors</a></li>
        </ul>
      </div>
    </div>
